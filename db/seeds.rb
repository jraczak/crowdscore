...
default_venue_categories = {
  "Restaurant" => ["American (New)", "American (Traditional)", "Bakery", "Barbecue", "Buffet", "Burgers", "Cafeteria", "Cajun", "Caribbean", "Chinese", "Coffee/Cafe", "Cuban", "Deli" , "Dessert", "Diner" , "Doughnut Shop", "Ethiopian", "Fast Food", "Food Stand/Cart", "French" , "German", "Greek", "Hot Dogs", "Ice Cream & Frozen Yogurt", "Indian" , "Irish", "Italian", "Jamaican", "Japanese/Sushi", "Juice & Smoothie Shop", "Korean", "Latin American", "Mongolian", "Mexican" , "Middle Eastern", "Pizza", "Sandwich Shop", "Seafood", "South American", "Spanish" , "Steakhouse", "Swedish", "Tapas", "Thai", "Vegan", "Vegetarian", "Vietnamese"],
